...
test_that("theme", {
  ...
  expect_equal(am_boxplot(example_grid)$theme$panel.grid.major$colour , "grey92")
  expect_equal(am_boxplot(example_grid)$theme$panel.grid.minor$colour , "grey92")
  ...
  expect_equal(am_dotplot(example_grid)$theme$panel.grid.major$colour , "grey92")
  expect_equal(am_dotplot(example_grid)$theme$panel.grid.minor$colour , "grey92")
...
test_that("theme", {
  ...
  expect_equal(am_barplot(example_trouvelot)$theme$panel.grid.major$colour , "grey92")
  expect_equal(am_barplot(example_trouvelot)$theme$panel.grid.minor$colour , "grey92")
  ...
  expect_equal(am_boxplot(example_trouvelot)$theme$panel.grid.major$colour , "grey92")
  expect_equal(am_boxplot(example_trouvelot)$theme$panel.grid.minor$colour , "grey92")
  ...
  expect_equal(am_dotplot(example_trouvelot)$theme$panel.grid.major$colour , "grey92")
  expect_equal(am_dotplot(example_trouvelot)$theme$panel.grid.minor$colour , "grey92")
